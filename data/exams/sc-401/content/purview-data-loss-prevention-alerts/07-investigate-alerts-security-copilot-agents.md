---
title: "Investigate DLP alerts with Security Copilot and AI agents"
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-alerts/investigate-alerts-security-copilot-agents"
uid: "learn.wwl.purview-data-loss-prevention-alerts.investigate-alerts-security-copilot-agents"
...
[![Screenshot showing the Alert Triage Agent view in Microsoft Purview with prioritized DLP alerts.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-triage-agent-alerts-view.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-triage-agent-alerts-view.png#lightbox)
...
The agent must be deployed and configured before you can use it. Deployment involves provisioning Security Compute Units (SCUs), enabling the Purview plugin in Security Copilot, and assigning an agent identity. For full setup steps, see [Get started with the Microsoft Purview Triage Agent in Data Loss Prevention](/en-us/purview/copilot-in-purview-triage-dlp-agent-get-started?azure-portal=true).
...
2.  In the upper-right corner, switch to **Alert triage agent (preview)** view.
    
3.  Review **Needs attention** alerts first.
    
4.  Select an alert to open the **Agent summary** pane and review the agent's categorization and triage notes.
    
5.  Use **Summarize** to generate an AI summary of the alert or user activity if you need more context.
    
6.  Select **View details** or update the alert as needed, for example by assigning it or notifying users.
    
    [![Screenshot showing the Agent summary pane in Microsoft Purview with DLP alert categorization and triage notes.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-triage-agent-summary.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-triage-agent-summary.png#lightbox)
...
*   The agent triages alerts from **Exchange, SharePoint, OneDrive, Teams, and devices (Endpoint)**. For device alerts, [evidence collection for file activities on devices](/en-us/purview/dlp-copy-matched-items-learn?azure-portal=true) must be enabled.
