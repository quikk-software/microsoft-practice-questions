...
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-alerts/data-loss-prevention-alert-lifecycle"
...
Microsoft Security Copilot is also available in some tenants and can help analyze alert context and suggest next steps. This feature is embedded in the [DLP Alerts dashboard](/en-us/purview/dlp-alerts-dashboard-get-started?azure-portal=true#investigate-a-dlp-alert) and in [Data Security Posture Management (preview)](/en-us/purview/data-security-posture-management-copilot?azure-portal=true#use-microsoft-security-copilot-with-data-security-posture-management-preview).
