---
title: "Investigate DLP alerts in Microsoft Defender XDR"
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-alerts/investigate-alerts-defender"
uid: "learn.wwl.purview-data-loss-prevention-alerts.investigate-alerts-defender"
...
3.  Select **Add filter**, choose **Service/detection sources**, and then select **Microsoft Data Loss Prevention**.

[![Screenshot showing the Microsoft Defender XDR filtering for data loss prevention alerts.](../../wwl-sci/purview-data-loss-prevention-alerts/media/investigate-alert-defender.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/investigate-alert-defender.png#lightbox)
...
[![Screenshot showing the Microsoft Defender XDR alert details page with attack story and Security Copilot pane.](../../wwl-sci/purview-data-loss-prevention-alerts/media/investigate-alert-defender.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/investigate-alert-defender.png#lightbox)
...
[![Screenshot showing the Manage incident flyout page in Microsoft Defender.](../../wwl-sci/purview-data-loss-prevention-alerts/media/defender-manage-incident.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/defender-manage-incident.png#lightbox)
...
1.  Use the [Microsoft Defender XDR connector](/en-us/azure/sentinel/connect-microsoft-365-defender?azure-portal=true) in Microsoft Sentinel to import DLP alerts and incidents.
