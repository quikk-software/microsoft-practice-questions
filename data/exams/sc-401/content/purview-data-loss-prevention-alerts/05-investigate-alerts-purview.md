---
title: "Investigate DLP alerts in Microsoft Purview"
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-alerts/investigate-alerts-purview"
uid: "learn.wwl.purview-data-loss-prevention-alerts.investigate-alerts-purview"
...
[![Screenshot showing Alerts dashboard in data loss prevention.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alerts-dashboard.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alerts-dashboard.png#lightbox)
...
[![Screenshot showing the details of a data loss prevention alert.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alerts-details.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alerts-details.png#lightbox)

### Step 3: View related user activity

If your organization has integrated **Insider Risk Management**, the **User activity summary** tab becomes available. For this tab to appear, [data sharing must be turned on in Insider Risk Management settings](/en-us/purview/insider-risk-management-settings-share-data?azure-portal=true), and the user must be in scope of an Insider Risk Management policy. Once enabled, the tab shows exfiltration activities the user engaged in over the past 120 days, so you can determine whether the alert is part of a larger pattern.

[![Screenshot showing user activity summary in a data loss prevention alert.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-activity-summary.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-activity-summary.png#lightbox)
...
*   Copy event link to share with someone else in your organization
    ...
    [![Screenshot showing the Events page of a data loss prevention alert.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-events.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-events.png#lightbox)
...
*   Set the alert **Status** to **Resolved** when the investigation is complete
    ...
    [![Screenshot showing the Overview page of a data loss prevention alert.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-overview.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-overview.png#lightbox)
...
*   Suggested follow-up actions
    ...
    [![Screenshot showing the Security Copilot pane embedded in the data loss prevention alerts dashboard.](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-security-copilot.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/data-loss-prevention-alert-security-copilot.png#lightbox)
...
2.  Select the event to share.
3.  Choose **Actions** > **Copy event link**.
4.  Paste the link into a chat, ticket, or email to share it with others.
