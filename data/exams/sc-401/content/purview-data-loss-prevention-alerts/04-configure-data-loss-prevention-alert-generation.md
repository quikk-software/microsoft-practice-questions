...
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-alerts/configure-data-loss-prevention-alert-generation"
...
3.  Create a new DLP policy or select an existing policy to modify.
    
4.  **Choose where to apply the policy** in locations such as Exchange, SharePoint, or devices.
    
5.  Create a new rule or edit an existing rule.
    
6.  After defining conditions and actions, configure incident reports and alerting behavior.
    ...
    [![Screenshot showing the configuration options for incident reports in a data loss prevention policy.](../../wwl-sci/purview-data-loss-prevention-alerts/media/configure-incident-reports.png)](../../wwl-sci/purview-data-loss-prevention-alerts/media/configure-incident-reports.png#lightbox)
    
7.  Choose to deploy your policy right away, in simulation mode, or off.
    
8.  Save and submit your policy settings.
