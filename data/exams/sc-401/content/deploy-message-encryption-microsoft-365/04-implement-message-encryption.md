---
title: "Configure Microsoft Purview Message Encryption"
url: "https://learn.microsoft.com/en-us/training/modules/deploy-message-encryption-microsoft-365/implement-message-encryption"
uid: "learn.wwl.deploy-message-encryption-microsoft-365.implement-message-encryption"
...
2.  Run the following command to verify that Azure RMS licensing is enabled:
...
3.  Then run a test to verify encryption is working:
...
If encryption isn't working or RMS templates aren't available, follow the [Azure RMS activation guidance](/en-us/azure/information-protection/activate-service?azure-portal=true).
