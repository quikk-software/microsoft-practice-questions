---
title: "Customize encrypted email branding with Microsoft Purview"
url: "https://learn.microsoft.com/en-us/training/modules/deploy-message-encryption-microsoft-365/branding-template"
uid: "learn.wwl.deploy-message-encryption-microsoft-365.branding-template"
...
[![Example of a branded encrypted email with a company logo, custom text, and background color.](../../wwl-sci/deploy-message-encryption-microsoft-365/media/branding-template.png)](../../wwl-sci/deploy-message-encryption-microsoft-365/media/branding-template.png#lightbox)
...
`Set-OMEConfiguration -Identity "Template 1" -Image ([System.IO.File]::ReadAllBytes('C:\Temp\logo.png'))`
...
3.  Customize it using `Set-OMEConfiguration`.
...
2.  Create a rule that matches the messages you want to brand (for example, based on sender group or keywords).
3.  Under **Do the following**, select **Apply custom branding to OME messages** and choose your branding template.
...
For a full list of supported color names and hex values, see [Microsoft documentation](/en-us/powershell/module/exchange/set-omeconfiguration?azure-portal=true).
