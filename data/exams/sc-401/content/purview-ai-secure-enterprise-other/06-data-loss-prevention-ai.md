---
title: "Protect sensitive data in AI apps with Microsoft Purview DLP"
url: "https://learn.microsoft.com/en-us/training/modules/purview-ai-secure-enterprise-other/data-loss-prevention-ai"
uid: "learn.wwl.purview-ai-secure-enterprise-other.data-loss-prevention-ai"
...
2.  On the **Overview** or **Recommendations** page, select either:
    
    *   **Extend your insights for data discovery**
    *   **Fortify your data security**
3.  Follow the prompts to create the recommended policy.
...
2.  Target one or more AI apps, such as ChatGPT or Gemini.
3.  Add conditions based on sensitive info types or custom classifiers.
4.  Configure the action to **Restrict browser and network activities**, such as **Text upload** > **Block**.
5.  Turn on simulation mode for testing, then enable full enforcement.
