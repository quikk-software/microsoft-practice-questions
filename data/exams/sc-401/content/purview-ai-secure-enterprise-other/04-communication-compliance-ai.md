---
title: "Identify policy violations with Communication Compliance"
url: "https://learn.microsoft.com/en-us/training/modules/purview-ai-secure-enterprise-other/communication-compliance-ai"
uid: "learn.wwl.purview-ai-secure-enterprise-other.communication-compliance-ai"
...
2.  Select **Policies**, then choose **Create policy**.
    
3.  Select a policy template that matches your scenario, or choose to create a custom policy.
    
4.  On the **Name and describe your policy** page, enter a name and optional description.
    
5.  On the **Choose users and reviewers** page, select the users and groups in scope, exclude any users if needed, and assign reviewers.
    
6.  On the **Choose locations to detect communications** page, select one or more generative AI locations:
    ...
    *   **Other AI apps**
        ...
        [![Screenshot showing selected communication detection locations, including Exchange, Teams, Viva Engage, and generative AI options like Copilot and other AI apps.](../../wwl-sci/purview-ai-secure-enterprise-other/media/communication-compliance-ai-locations.png)](../../wwl-sci/purview-ai-secure-enterprise-other/media/communication-compliance-ai-locations.png#lightbox)
        
7.  On the **Choose conditions and review percentage** page, adjust the **Review percentage** to control how often interactions are flagged. You can also add conditions such as:
    
    *   Sensitive information types
    *   Keyword dictionaries
    *   Trainable classifiers
    *   Content safety classifiers
8.  Review your policy settings, then select **Create policy**.
