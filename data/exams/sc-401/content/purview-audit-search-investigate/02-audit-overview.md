---
title: "Understand how Microsoft Purview Audit works"
url: "https://learn.microsoft.com/en-us/training/modules/purview-audit-search-investigate/audit-overview"
uid: "learn.wwl.purview-audit-search-investigate.audit-overview"
...
180 days, or 1 year for Microsoft Entra ID, Exchange, SharePoint, and OneDrive
...
The healthcare compliance team turned on Audit (Standard) six months ago and hasn't upgraded to Audit (Premium). They want to know whether a physician opened a specific patient email 30 days ago. What does the mental model of audit predict they'll find?

The record will be there. Standard covers Exchange mailbox activity across the tenant.

The record won't be there because Standard's retention window is only 30 days for mailbox activity.

The record won't be there because message-level opens come from `MailItemsAccessed`, an Audit (Premium) event.
