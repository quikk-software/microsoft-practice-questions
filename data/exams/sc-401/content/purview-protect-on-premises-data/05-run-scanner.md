---
title: "Run and manage the scanner"
url: "https://learn.microsoft.com/en-us/training/modules/purview-protect-on-premises-data/run-scanner"
uid: "learn.wwl.purview-protect-on-premises-data.run-scanner"
...
2.  Select your job, then select **Scan now**.

**Using PowerShell**: Run this command:
