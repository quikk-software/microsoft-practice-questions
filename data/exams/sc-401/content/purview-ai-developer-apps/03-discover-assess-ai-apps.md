---
title: "Discover and assess AI apps with DSPM for AI"
url: "https://learn.microsoft.com/en-us/training/modules/purview-ai-developer-apps/discover-assess-ai-apps"
uid: "learn.wwl.purview-ai-developer-apps.discover-assess-ai-apps"
module: "purview-ai-developer-apps"
moduleTitle: "Secure developer AI environments with Microsoft Purview"
...
[![Screenshot showing reports of total interactions for Copilot, agents, and enterprise AI apps in the last 30 days.](../../wwl-sci/purview-ai-developer-apps/media/posture-management-ai-reports-dashboard.png)](../../wwl-sci/purview-ai-developer-apps/media/posture-management-ai-reports-dashboard.png#lightbox)
...
*   **Secure interactions in Microsoft Copilot experiences** automatically captures activity from Copilot Studio agents and copilots embedded in Teams or Fabric.
    ...
    [![Screenshot showing confirmation of a policy created to capture enterprise AI app interactions for compliance and data management.](../../wwl-sci/purview-ai-developer-apps/media/posture-management-ai-enterprise-app-recommendation.png)](../../wwl-sci/purview-ai-developer-apps/media/posture-management-ai-enterprise-app-recommendation.png#lightbox)
...
*   **Interactions** across Microsoft 365 workloads not covered by default
    ...
    [![Screenshot showing a list of DSPM collection policies for AI interactions and sensitive info detection on the Collection policies page.](../../wwl-sci/purview-ai-developer-apps/media/collection-policies.png)](../../wwl-sci/purview-ai-developer-apps/media/collection-policies.png#lightbox)
