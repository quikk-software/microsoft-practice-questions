...
url: "https://learn.microsoft.com/en-us/training/modules/purview-ediscovery-search/export-results"
...
*   **Only partially indexed items** (useful in special cases, such as if you're following up on indexing issues)
    ...
    [![Screenshot showing the index options for an eDiscovery export.](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export.png)](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export.png#lightbox)
...
*   Whether to include attachments from SharePoint lists
    ...
    [![Screenshot showing the OneDrive and SharePoint export options for eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-onedrive-sharepoint.png)](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-onedrive-sharepoint.png#lightbox)
...
*   **Include cloud attachments** from SharePoint or OneDrive, and choose the version range to include
    ...
    [![Screenshot showing the message and mailbox export options for eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-mailbox-teams.png)](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-mailbox-teams.png#lightbox)
...
*   Generate **friendly names** for items to make them easier to reference
    ...
    [![Screenshot showing the type and format export options for eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-type-format.png)](../../wwl-sci/purview-ediscovery-search/media/ediscovery-export-type-format.png#lightbox)
...
2.  In the **Export packages** section, review the list of downloadable files, including message content, reports, and item metadata.
3.  Select the checkboxes next to the files you want to download.
4.  Select Download.

[![Screenshot showing the download packages view in eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/download-export.png)](../../wwl-sci/purview-ediscovery-search/media/download-export.png#lightbox)
