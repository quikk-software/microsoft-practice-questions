...
url: "https://learn.microsoft.com/en-us/training/modules/purview-ediscovery-search/conduct-ediscovery-search"
...
2.  In the **Search for sources** pane, you can filter by:
    
    *   All people and groups (default)
    *   People only
    *   Groups only
3.  Enter the name, email address, or URL of the source. For SharePoint and OneDrive, enter a full site or account URL.
    
4.  Optionally, select **Exclude inactive users** to limit the results.
    
5.  Choose your sources, then select **Save and close**.
    
    [![Screenshot showing where to select data sources in eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/select-data-sources.png)](../../wwl-sci/purview-ediscovery-search/media/select-data-sources.png#lightbox)
...
[![Screenshot showing an example query in the condition builder in eDiscovery.](../../wwl-sci/purview-ediscovery-search/media/condition-builder.png)](../../wwl-sci/purview-ediscovery-search/media/condition-builder.png#lightbox)
...
[![Screenshot showing Copilot generating KeyQL code with Copilot.](../../wwl-sci/purview-ediscovery-search/media/generate-keyql-copilot.png)](../../wwl-sci/purview-ediscovery-search/media/generate-keyql-copilot.png#lightbox)
...
2.  Choose **Attach files**, then select one of the following:
...
3.  After uploading, your file appears in the table with its details.
...
2.  Choose your preferred result type:
