---
title: "Create and publish retention labels"
url: "https://learn.microsoft.com/en-us/training/modules/purview-retention-recovery/create-publish-retention-label"
uid: "learn.wwl.purview-retention-recovery.create-publish-retention-label"
...
3.  On the **Name your retention label** page, enter a name and optional descriptions for admins and users.
    
    *   The name can't be changed after the label is saved.
4.  On the **Define label settings** page, choose how the label manages content:
...
5.  On the **Define the retention period** page, set the retention period and when it starts:
    
    *   Options include when content is created, modified, labeled, or when a specific event occurs.
6.  On the **Choose what happens after the retention period** page, choose what happens when the retention period ends:
...
7.  Review your settings, then create the retention label.
...
3.  On the **Choose labels to publish** page, add the retention label you'd like to publish.
    
4.  On the **Policy scope** page, optionally add admin units.
    
5.  On the **Choose the type of retention policy to create​** page, choose between an **Adaptive** or **Static** policy scope.
    
    *   Adaptive scopes require separate setup and allow targeting by user, site, or group attributes.
6.  On the **Choose where to apply this policy** page, select to publish the label to all locations or select specific locations for the label.
    
    [![Screenshot showing locations available to apply a retention label policy.](../../wwl-sci/purview-retention-recovery/media/retention-label-policy-locations.png)](../../wwl-sci/purview-retention-recovery/media/retention-label-policy-locations.png#lightbox)
    
7.  Name your retention label policy, then review and submit your settings to publish your retention label to a retention label policy.
...
[![Diagram illustrating when retention label policies are available to apply.](../../wwl-sci/purview-retention-recovery/media/retention-labels-published-timings.png)](../../wwl-sci/purview-retention-recovery/media/retention-labels-published-timings.png#lightbox)
