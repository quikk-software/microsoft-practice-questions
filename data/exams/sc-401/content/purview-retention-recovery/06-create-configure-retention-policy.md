---
title: "Create and configure retention policies"
url: "https://learn.microsoft.com/en-us/training/modules/purview-retention-recovery/create-configure-retention-policy"
uid: "learn.wwl.purview-retention-recovery.create-configure-retention-policy"
...
6.  On the **Choose where to apply this policy** page, select the locations where the labels should be available.
    
    [![Screenshot showing locations available to apply a retention label policy.](../../wwl-sci/purview-retention-recovery/media/retention-policy-locations.png)](../../wwl-sci/purview-retention-recovery/media/retention-label-policy-locations.png#lightbox)
    
7.  On the **Decide if you want to retain content, delete it, or both** page, choose whether to retain items, delete them, or do both. Options include:
...
8.  Review your settings, then create the retention label policy.
...
[![Diagram illustrating when retention policies are available to apply.](../../wwl-sci/purview-retention-recovery/media/retention-policy-timings.png)](../../wwl-sci/purview-retention-recovery/media/retention-policy-timings.png#lightbox)
