---
title: "Create and manage auto-apply retention labels"
url: "https://learn.microsoft.com/en-us/training/modules/purview-retention-recovery/auto-apply-retention-label"
uid: "learn.wwl.purview-retention-recovery.auto-apply-retention-label"
...
2.  Run the policy in simulation mode.
3.  Review the results, including how many items match and where they're located.
4.  Adjust the conditions if needed and rerun simulation.
5.  When ready, turn on the policy to start labeling content.
...
2.  Select **Policies** > **Label policies** > **Auto-apply a label**.
    
3.  On the **Let's get started** page, enter a name and optional description.
    
4.  On the **Choose the type of content you want to apply this label to** page, choose the condition to trigger labeling:
    
    *   Sensitive info types
    *   Keywords or searchable properties
    *   Trainable classifiers
    *   Cloud attachments
5.  On the **Policy scope** page, keep the default of **Full directory**. Currently, admin units aren't supported for this policy.
    
6.  Choose a **Static** or **Adaptive** policy scope:
    
    *   Adaptive scopes require separate setup and allow targeting by user, site, or group attributes.
7.  On the **Choose where to automatically apply the label** page, choose whether to include all locations or specify only certain ones.
    
8.  On the **Choose a label to auto-apply** page, select **Add label** and select the label for your auto-apply policy.
    
9.  On the **Decide whether to test or run your policy** page, choose to run your policy in simulation mode, or turn the policy on right away.
    
10.  Review your settings, then submit your configuration to create the auto-apply label.
...
[![Diagram illustrating when auto-apply retention label policies are available.](../../wwl-sci/purview-retention-recovery/media/auto-apply-labels-published-timings.png)](../../wwl-sci/purview-retention-recovery/media/auto-apply-labels-published-timings.png#lightbox)
