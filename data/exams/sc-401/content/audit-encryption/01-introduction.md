---
title: "Introduction to Microsoft 365 encryption"
url: "https://learn.microsoft.com/en-us/training/modules/audit-encryption/introduction"
uid: "learn-m365.audit-encryption.introduction"
...
Encrypting information renders it unreadable to those who don’t possess the right key who manage to bypass other security controls. Even if an adversary were able to break through firewalls, infiltrate the network, obtain physical access to devices, or bypass permissions on a local machine, the data in our systems would remain protected by strong encryption. A malicious attacker who obtained encrypted data without the appropriate key would be unable to decrypt and read the stolen data.
...
**Examples of data-in-transit** include email messages that are in the process of being delivered or conversations that are taking place in an online meeting. Data is in transit whenever a user's device is communicating with a Microsoft server, or when Microsoft servers are communicating with one another.
