...
url: "https://learn.microsoft.com/en-us/training/modules/purview-insider-risk-investigate-alerts/investigate-alerts-defender"
...
2.  Use the **Service source** filter to select **Microsoft Purview Insider Risk Management**
    ...
    [![Screenshot showing the Incidents page being filtered to show Microsoft Purview Insider Risk Management incidents.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/defender-insider-risk-incidents.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/defender-insider-risk-incidents.png#lightbox)
...
Insider Risk Management status
...
Dismissed or Confirmed (based on classification)

How classification types align:

Microsoft Defender classification

Insider Risk Management classification

True positive

Confirmed

Information, expected activity
...
3.  Enable **Share user risk details with other security solutions**.
    ...
    [![Screenshot showing where to enable data sharing in Microsoft Purview Insider Risk Management.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/enable-data-sharing-insider-risk-settings.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/enable-data-sharing-insider-risk-settings.png#lightbox)
