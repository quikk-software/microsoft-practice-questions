---
title: "Investigate insider risk alerts with Security Copilot and AI agents"
url: "https://learn.microsoft.com/en-us/training/modules/purview-insider-risk-investigate-alerts/investigate-alerts-security-copilot-agents"
uid: "learn.wwl.purview-insider-risk-investigate-alerts.investigate-alerts-security-copilot-agents"
...
*   **Not categorized**: Alerts that couldn't be evaluated, such as those triggered by unsupported policy types
    ...
    [![Screenshot showing the Alert triage agent view in Microsoft Purview Insider Risk Management with filter and category options for triaged alerts.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/triage-agent-alerts-filter-view.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/triage-agent-alerts-filter-view.png#lightbox)
...
6.  Select **View details** or take actions such as assigning ownership, escalating to a case, or applying adaptive protection.
    ...
    [![Screenshot showing the Agent summary view in Microsoft Purview Insider Risk Management with categorized risk factors and user alert history.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/triage-agent-alert-summary.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/triage-agent-alert-summary.png#lightbox)
