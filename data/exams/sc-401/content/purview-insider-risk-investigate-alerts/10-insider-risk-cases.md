...
url: "https://learn.microsoft.com/en-us/training/modules/purview-insider-risk-investigate-alerts/insider-risk-cases"
...
[![Screenshot showing how to create a case in Insider Risk Management.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-create-case.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-create-case.png#lightbox)
...
[![Screenshot showing the Cases dashboard in Insider Risk Management.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-case-details.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-case-details.png#lightbox)
...
*   **Contributors**: Users added to the case for collaboration
    ...
    [![Screenshot showing details of a case investigation.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-case-details.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-case-details.png#lightbox)
...
2.  Select **Settings** > **Insider Risk Management** > **Microsoft Teams**.
    
3.  Select the toggle to enable integration with Microsoft Teams.
    
    [![Screenshot showing where to enable Teams integration in Microsoft Purview Insider Risk Management.](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-teams-integration.png)](../../wwl-sci/purview-insider-risk-investigate-alerts/media/insider-risk-teams-integration.png#lightbox)
