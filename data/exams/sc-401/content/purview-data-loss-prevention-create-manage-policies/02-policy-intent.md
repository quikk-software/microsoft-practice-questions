---
title: "Understand how DLP policy decisions fit together"
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-create-manage-policies/policy-intent"
uid: "learn.wwl.purview-data-loss-prevention-create-manage-policies.policy-intent"
...
[![Diagram illustrating the DLP policy lifecycle, including intent, detection rules, scope, actions, simulation mode, and policy management.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/create-data-loss-prevention-policy-flow.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/create-data-loss-prevention-policy-flow.png#lightbox)
