---
title: "Summary"
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-create-manage-policies/summary"
uid: "learn.wwl.purview-data-loss-prevention-create-manage-policies.summary"
...
Creating effective data loss prevention (DLP) policies starts with understanding why the policy exists and how each design decision affects behavior. DLP isn't just about blocking activity. It's about evaluating data in context, guiding users appropriately, and reducing risk without disrupting normal work.
...
*   [Learn about data loss prevention](/en-us/purview/dlp-learn-about-dlp?azure-portal=true)
*   [Create and deploy data loss prevention policies](/en-us/purview/dlp-create-deploy-policy?azure-portal=true)
*   [Send email notifications and show policy tips for DLP policies](/en-us/purview/dlp-use-notifications-and-policy-tips?azure-portal=true)
