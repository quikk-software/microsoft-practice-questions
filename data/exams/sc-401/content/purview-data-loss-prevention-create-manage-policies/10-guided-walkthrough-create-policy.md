...
url: "https://learn.microsoft.com/en-us/training/modules/purview-data-loss-prevention-create-manage-policies/guided-walkthrough-create-policy"
uid: "learn.wwl.purview-data-loss-prevention-create-manage-policies.guided-walkthrough-create-policy"
module: "purview-data-loss-prevention-create-manage-policies"
moduleTitle: "Create and manage data loss prevention policies"
...
2.  From **Solutions**, select **Data Loss Prevention**.
    
3.  Open **Policies**, then select **Create policy**.
    
    [![Screenshot of the Data Loss Prevention Policies page in Microsoft Purview showing the Create policy option.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-create-policy.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-create-policy.png#lightbox)
...
*   Select **Enterprise applications and devices** to continue.
    ...
    [![Screenshot of the policy type selection page in Microsoft Purview showing Enterprise applications and devices selected.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-enterprise-apps.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-enterprise-apps.png#lightbox)
...
*   Choose to create a **custom policy**.
    ...
    [![Screenshot of the policy template selection page in Microsoft Purview showing the Custom policy option.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-custom-policy.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/select-custom-policy.png#lightbox)
    

**Decision:** Template or custom policy. Templates provide predefined assumptions for common scenarios. A custom policy allows full control over detection logic, scope, and actions, which is useful when policies need to reflect specific workflows or risk tolerance.
...
2.  Deselect any locations that aren't relevant to the scenario.
    
    The image shows the location selection page. Select the image to view the locations used in this scenario.
    
    [![Screenshot of the DLP location selection page in Microsoft Purview with several Microsoft 365 locations selected.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/policy-locations.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/policy-locations-selected.png#lightbox)
...
**Decision:** Detection signals and context. Using classification alone can generate noise. Adding context helps focus enforcement on higher-risk activity and improves accuracy.
...
**Decision:** How the policy responds. Actions shape the user experience. Starting with guidance allows the organization to understand behavior patterns before introducing stricter enforcement.
...
**Decision:** User flexibility and accountability. Overrides balance protection with productivity. Requiring justification helps reduce misuse while preserving flexibility.
...
*   [Rule name and conditions](#tabpanel_1_name-conditions)
*   [Actions](#tabpanel_1_actions)
*   [Notifications and reporting](#tabpanel_1_notifications-reporting)

This section defines what the rule detects and when it triggers.

[![Screenshot of the Create rule page in Microsoft Purview showing the rule name, description, and content conditions.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/names-conditions.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/names-conditions.png#lightbox)

This section determines how the policy responds when the rule conditions are met.

[![Screenshot of the Actions section in the Create rule page in Microsoft Purview showing restrict access options with external users blocked.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/actions.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/actions.png#lightbox)

This section controls user guidance and how rule activity is surfaced to administrators.

[![Screenshot of the Create rule page in Microsoft Purview showing user notifications, overrides, incident reporting settings, and the Save button.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/notifications-reports.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/notifications-reports.png#lightbox)
...
[![Screenshot of the Policy mode page in Microsoft Purview showing simulation mode selected with policy tips enabled.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/policy-mode-selection.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/policy-mode-selection.png#lightbox)
...
2.  Confirm the locations where the policy applies.
3.  Verify the rule and policy mode settings.
4.  Select **Submit** to create the policy.
...
[![Screenshot of the Review and finish page in Microsoft Purview showing policy details, selected locations, rule settings, and the Submit button.](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/review-finish.png)](../../wwl-sci/purview-data-loss-prevention-create-manage-policies/media/review-finish.png#lightbox)
...
*   [Create and deploy data loss prevention policies](/en-us/purview/dlp-create-deploy-policy?azure-portal=true)
*   [Help prevent sharing sensitive items via SharePoint and OneDrive with external users](/en-us/purview/dlp-create-policy-spo-odb-external?azure-portal=true)
*   [Help prevent sharing credit card numbers through email](/en-us/purview/dlp-create-policy-cc-email?azure-portal=true)
