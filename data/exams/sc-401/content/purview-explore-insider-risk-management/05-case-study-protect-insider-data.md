---
title: "Case study: Protect sensitive data with Insider Risk Management"
url: "https://learn.microsoft.com/en-us/training/modules/purview-explore-insider-risk-management/case-study-protect-insider-data"
uid: "learn.wwl.purview-explore-insider-risk-management.case-study-protect-insider-data"
...
2.  **Investigation**: Using **Content explorer**, the investigator examines the downloaded files. These include product roadmaps and client presentations marked with a "Confidential" [sensitivity label](/en-us/purview/sensitivity-labels?azure-portal=true).
