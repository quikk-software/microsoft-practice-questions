---
title: "Microsoft Purview Insider Risk Management features"
url: "https://learn.microsoft.com/en-us/training/modules/purview-explore-insider-risk-management/insider-risk-management-features"
uid: "learn.wwl.purview-explore-insider-risk-management.insider-risk-management-features"
module: "purview-explore-insider-risk-management"
moduleTitle: "Understand Microsoft Purview Insider Risk Management"
...
2.  **Customize conditions**: Adjust criteria like detection timeframes, user groups, and activity types to fit your organization's needs.
3.  **Create policies**: Begin receiving alerts based on the defined conditions.
4.  **Review and refine**: Use insights from alerts and analytics to update policy criteria and improve accuracy.
...
*   **Alerts dashboard**: Helps reviewers prioritize risks by displaying the severity, status, and type of activities flagged by policies. It highlights critical alerts, enabling quick action on high-priority risks.
    ...
    [![Screenshot showing the alerts dashboard in Insider Risk Management.](../../wwl-sci/purview-explore-insider-risk-management/media/insider-risk-alerts-dashboard.png)](../../wwl-sci/purview-explore-insider-risk-management/media/insider-risk-alerts-dashboard.png#lightbox)
...
*   **[eDiscovery (Premium)](/en-us/purview/ediscovery-overview?azure-portal=true)** enables legal teams to manage investigations involving insider risks.
*   **[Microsoft Defender for Endpoint](/en-us/defender-endpoint/microsoft-defender-endpoint?azure-portal=true)** contributes alerts about device-related risks.
*   **[Communication Compliance](/en-us/purview/communication-compliance-solution-overview?azure-portal=true)** helps address risks related to inappropriate messaging behavior.
