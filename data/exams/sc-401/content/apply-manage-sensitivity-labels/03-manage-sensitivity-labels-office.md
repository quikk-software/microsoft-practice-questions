...
url: "https://learn.microsoft.com/en-us/training/modules/apply-manage-sensitivity-labels/manage-sensitivity-labels-office"
uid: "learn.wwl.apply-manage-sensitivity-labels.manage-sensitivity-labels-office"
...
This is the baseline format for reliable label protection. For the minimum Office version needed for specific label features, see [Minimum versions for sensitivity labels in Office apps](/en-us/purview/sensitivity-labels-versions?azure-portal=true).
...
[![Screenshot of sensitivity labels on the window title bar.](../../wwl-sci/apply-manage-sensitivity-labels/media/sensitivity-bar-example.png)](../../wwl-sci/apply-manage-sensitivity-labels/media/sensitivity-bar-example.png#lightbox)

In classic Outlook, the sensitivity bar appears on the **Subject** line of the email.

[![Screenshot of sensitivity labels on the Outlook Subject line.](../../wwl-sci/apply-manage-sensitivity-labels/media/sensitivity-bar-example-outlook.png)](../../wwl-sci/apply-manage-sensitivity-labels/media/sensitivity-bar-example-outlook.png#lightbox)
...
![Screenshot of a dialog box prompting users to use sensitivity labels from the sensitivity bar.](../../wwl-sci/apply-manage-sensitivity-labels/media/irm-redirect-sensitivity-labels.png)
...
Which statement describes the effect of applying sensitivity labels to emails and documents for cross-organizational sharing?

Sensitivity labels don't play a role in cross-organizational sharing.

Sensitivity labels prevent any form of cross-organizational sharing.

Sensitivity labels ensure data sharing respects the data protection policies of both sending and receiving organizations.
