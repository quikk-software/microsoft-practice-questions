---
title: "Create a custom Insider Risk Management policy"
url: "https://learn.microsoft.com/en-us/training/modules/purview-create-manage-insider-risk-policy/create-custom-insider-risk-policy"
uid: "learn.wwl.purview-create-manage-insider-risk-policy.create-custom-insider-risk-policy"
...
1.  Sign in to the [Microsoft Purview portal](https://purview.microsoft.com/?azure-portal=true) using credentials with [appropriate permissions for Insider Risk Management](/en-us/purview/insider-risk-management-configure?azure-portal=true#step-1-required-enable-permissions-for-insider-risk-management).
    
2.  Navigate to **Solutions** > **Insider Risk Management** > **Policies**
    
3.  Select **Create policy** > **Custom policy**.
    
4.  Review available templates and choose one. Confirm that you meet any prerequisites listed, such as configuring the HR Connector or integrating Microsoft Defender for Endpoint.
    
    [![Screenshot showing the available policy templates in Insider Risk Management.](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-policy-template.png)](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-policy-template.png#lightbox)
...
[![Screenshot showing the Name your policy screen when creating an insider risk policy.](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-name-your-policy.png)](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-name-your-policy.png#lightbox)
...
2.  If you select **I want to prioritize content**, you can configure the policy to prioritize specific types of content:
...
3.  Complete the configuration by selecting the specific SharePoint sites, labels, sensitive info types, file extensions, or trainable classifiers you want to prioritize. These settings ensure that activities involving this content are assigned higher risk scores, increasing the likelihood of generating high-severity alerts.
    
    [![Screenshot showing what content to prioritize when creating an Insider Risk Management policy.](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-prioritize-content.png)](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-prioritize-content.png#lightbox)
...
[![Screenshot showing where to define policy triggers in Insider Risk Management.](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-triggering-event.png)](../../wwl-sci/purview-create-manage-insider-risk-policy/media/insider-risk-triggering-event.png#lightbox)
...
2.  On the **Detection options** page, enable advanced detection features if applicable:
...
3.  On the **Choose threshold type for indicators** page, define the sensitivity of alerts generated by the policy:
