...
url: "https://learn.microsoft.com/en-us/training/modules/purview-review-analyze-data-classification/information-protection-reports"
...
2.  Select **Solutions** > **Information Protection** from the left navigation pane.
    
3.  On the **Information Protection** page, select **Reports**.
    

On the **Reports** page, use the filter at the top to view classification and protection insights by data source:

[![Screenshot showing the top level filter for the Reports page within Information Protection.](../../wwl-sci/purview-review-analyze-data-classification/media/information-protection-reports-top-filter.png)](../../wwl-sci/purview-review-analyze-data-classification/media/information-protection-reports-top-filter.png#lightbox)
...
[![Screenshot showing the Explore applied labels button linking to Data explorer in Information Protection reports.](../../wwl-sci/purview-review-analyze-data-classification/media/report-link-to-data-explorer.png)](../../wwl-sci/purview-review-analyze-data-classification/media/report-link-to-data-explorer.png#lightbox)
...
Percentage of encrypted and access-controlled data across cloud and on-premises sources.

Identifies gaps in encryption and access control policies.

Protection policies (preview)

**Sensitivity label coverage**

Percentage of labeled vs. unlabeled items across Microsoft 365, Azure, AWS, and on-premises.

Ensures sensitive data is labeled for proper protection and governance.

Data Explorer

**Data scanning summary**

Percentage of scanned data sources across cloud and on-premises.

Detects unscanned areas that might pose compliance risks.

Scan reports

**Sensitivity label usage**

Top sensitivity labels applied to files across all connected environments.

Helps track label adoption trends and identify policy gaps.

Data Explorer

**Email encryption summary**

Number of emails encrypted manually or by policy.

Ensures confidential emails are properly protected.

Encryption reports

**Top activities detected**

Logs of file access, labeling changes, DLP matches, and encryption actions.

Detects unauthorized modifications or suspicious access patterns.

Activity Explorer

**Sensitive information types (SITs)**

Most commonly detected sensitive data types (for example, credit card numbers, SSNs, medical data).

Helps identify high-risk data needing protection.

Data Explorer

**Data sources with sensitive info**

Top locations where labeled or sensitive data is stored (for example, SharePoint, OneDrive, Exchange, Azure).

Identifies data concentration areas to enhance security controls.

Data Explorer

**Trainable classifiers**

Most-used AI classifiers for autolabeling (for example, threat intelligence, HR records).

Supports automated classification for large-scale data protection.
