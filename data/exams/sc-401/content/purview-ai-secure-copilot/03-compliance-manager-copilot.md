---
title: "Assess Copilot regulatory compliance with Compliance Manager"
url: "https://learn.microsoft.com/en-us/training/modules/purview-ai-secure-copilot/compliance-manager-copilot"
uid: "learn.wwl.purview-ai-secure-copilot.compliance-manager-copilot"
...
2.  Select **Assessments**, then choose **\+ Add assessment**.
    
3.  In the guided flow:
    
    1.  Select one of the AI regulation templates
        
    2.  Assign the assessment to a new or existing group
        
    3.  Choose **Microsoft 365** as the service
        
    4.  Review and confirm your settings
        
        [![Screenshot showing Compliance Manager with the NIST AI Risk Management Framework selected as a regulation for Microsoft 365 assessments.](../../wwl-sci/purview-ai-secure-copilot/media/compliance-manager-ai-assessment.png)](../../wwl-sci/purview-ai-secure-copilot/media/compliance-manager-ai-assessment.png#lightbox)
