---
title: "Analyze Copilot interactions with Communication Compliance"
url: "https://learn.microsoft.com/en-us/training/modules/purview-ai-secure-copilot/communication-compliance-copilot"
uid: "learn.wwl.purview-ai-secure-copilot.communication-compliance-copilot"
...
3.  Choose the **Detect Microsoft Copilot interactions** template.
    
    [![Screenshot showing the Communication Compliance policy creation menu with Detect Microsoft Copilot interactions selected as a policy template.](../../wwl-sci/purview-ai-secure-copilot/media/detect-copilot-interactions-template.png)](../../wwl-sci/purview-ai-secure-copilot/media/detect-copilot-interactions-template.png#lightbox)
    
4.  Name your policy, choose users and groups, and assign reviewers.
    
5.  Review the settings, then create the policy or choose to customize it before saving.
...
*   **Other AI apps**: Third-party or browser-based AI tools
    ...
    [![Screenshot showing selected communication detection locations, including Exchange, Teams, Viva Engage, and generative AI options like Copilot and other AI apps.](../../wwl-sci/purview-ai-secure-copilot/media/communication-compliance-ai-locations.png)](../../wwl-sci/purview-ai-secure-copilot/media/communication-compliance-ai-locations.png#lightbox)
...
3.  Select the **Detect unethical behavior in AI apps** recommendation.
    
4.  Review the policy details, then select **Create policies** to create the policy with default settings.
    
    [![Screenshot in DSPM for AI showing setup prompt for a policy to detect unethical behavior in Microsoft 365 Copilot and other AI apps using pay-as-you-go billing.](../../wwl-sci/purview-ai-secure-copilot/media/posture-management-communication-compliance-copilot.png)](../../wwl-sci/purview-ai-secure-copilot/media/posture-management-communication-compliance-copilot.png#lightbox)
    
5.  After the policy is created, go to the **Communication Compliance** solution and edit the policy to assign reviewers or make other changes.
