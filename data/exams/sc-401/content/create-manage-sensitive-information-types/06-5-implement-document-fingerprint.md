---
title: "Implement document fingerprinting"
url: "https://learn.microsoft.com/en-us/training/modules/create-manage-sensitive-information-types/5-implement-document-fingerprint"
uid: "learn.wwl.create-manage-sensitive-information-types.implement-document-fingerprinting"
...
2.  **Fingerprint matching**: When a document containing that patent template is scanned, the DLP system detects a match based on the unique fingerprint and applies the relevant policy to manage the document accordingly.
    

[![Diagram illustrating the workflow for document fingerprinting.](../../wwl-sci/create-manage-sensitive-information-types/media/document-finger.png)](../../wwl-sci/create-manage-sensitive-information-types/media/document-finger.png#lightbox)
...
3.  On the **Name your fingerprint based SIT** page, enter a name and description for your new SIT, then select **Next**.
    
4.  **Upload a file to create a fingerprint for the file**, then optionally adjust the requirements for each confidence level.
    
    [![Screenshot showing where to adjust the confidence level in creating a document fingerprint SIT.](../../wwl-sci/create-manage-sensitive-information-types/media/document-fingerprinting-confidence-levels.png)](../../wwl-sci/create-manage-sensitive-information-types/media/document-fingerprinting-confidence-levels.png#lightbox)
    
    To use exact matching, expand the dropdown for **High**, then select **Exact**.
    
5.  Select **Next**.
    
6.  On the **Review settings and finish** page, review your settings, then select **Create**.
    
7.  On the confirmation page, select **Done**.
    

To use document fingerprinting with devices, [**Advanced classification scanning and protection**](/en-us/purview/dlp-configure-endpoint-settings#advanced-classification-scanning-and-protection?azure-portal=true) must be turned on.
...
For more information about creating a new DLP policy using fingerprint-based SITS, see [Create a new policy using your fingerprint SIT](/en-us/purview/document-fingerprinting#create-a-new-policy-using-your-fingerprint-sit-using-the-compliance-portal?azure-portal=true).
