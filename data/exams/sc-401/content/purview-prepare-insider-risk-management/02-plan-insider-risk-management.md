...
url: "https://learn.microsoft.com/en-us/training/modules/purview-prepare-insider-risk-management/plan-insider-risk-management"
uid: "learn.wwl.purview-prepare-insider-risk-management.plan-insider-risk-management"
...
*   **Policy template prerequisites**: Specific templates have additional requirements:
    ...
    *   **Data theft by departing users**: Requires configuring an [HR connector](/en-us/purview/import-hr-data?azure-portal=true) to import resignation and termination data.
    *   **Data leaks**: Requires [creating and deploying a data loss prevention policy](/en-us/purview/dlp-create-deploy-policy?azure-portal=true) to define sensitive information.
    *   **Security policy violation**: Requires [integration with Microsoft Defender for Endpoint](/en-us/defender-endpoint/advanced-features?azure-portal=true) to import security alerts.
...
*   [Create and manage insider risk management policies](/en-us/purview/insider-risk-management-policies?azure-portal=true).
*   [Investigate insider risk management activities](/en-us/purview/insider-risk-management-activities?azure-portal=true).
*   [Review data with the insider risk management content explorer](/en-us/purview/insider-risk-management-content-explorer?azure-portal=true).
