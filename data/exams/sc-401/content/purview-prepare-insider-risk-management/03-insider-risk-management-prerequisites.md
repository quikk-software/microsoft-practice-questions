---
title: "Prepare your organization for Insider Risk Management"
url: "https://learn.microsoft.com/en-us/training/modules/purview-prepare-insider-risk-management/insider-risk-management-prerequisites"
uid: "learn.wwl.purview-prepare-insider-risk-management.insider-risk-management-prerequisites"
...
![Screenshot showing the top recommendations for insider risk management.](../../wwl-sci/purview-prepare-insider-risk-management/media/insider-risk-management-recommendations.png)
...
2.  Navigate to **Settings** on the left sidebar, then select **Roles and scopes** > **Roles groups**.
3.  Select the appropriate role group, for example _Insider Risk Management Admin_, then select **Edit**.
4.  Select **Choose users**, then select the checkboxes for the users you want to add to the role group.
5.  Select **Next**, then select **Save** to save your settings.

### Step 2: Enable Microsoft 365 Audit logs

Audit logs capture essential activity data for analytics and alerts. Verify auditing is active by running this command in [Exchange Online PowerShell](/en-us/powershell/exchange/connect-to-exchange-online-powershell?azure-portal=true):
...
For step-by-step instructions on enabling audit logging in Microsoft 365, see [Turn auditing on or off](/en-us/purview/audit-log-enable-disable?azure-portal=true#turn-on-auditing)
...
2.  Navigate to the **Insider Risk Management** solution.
    
3.  On the **Overview** tab, on the **Scan for insider risks in your organization** card, select **Run scan**. This action turns on analytics scanning for your organization.
...
To learn more about third-party data connectors, see [Learn about connectors for third-party data](/en-us/purview/archive-third-party-data?azure-portal=true)
